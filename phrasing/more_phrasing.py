...
NON_PHRASE_STROKES = {
    ...
    # my additions
    # since SWH is now when
    "SWH": True,         # "is when"
    "SWHA": True,        # "is what"
    "SWHA*": True,       # "schwa"
    "SWHAE": True,       # "what she"
    "SWHAEL": True,      # "sexually"
    "SWHAU": True,       # "schwa"
    "SWHAR/PHA": True,   # "shawarma"
    "SWHAPS": True,      # "what happens is"
    "SWHAL": True,       # "sexual"
    "SWHALT": True,      # "sexuality"
    "SWHAT": True,       # "somewhat"

    # since STPHR is now if
    "STPHRAOUGS": True,  # "institution",
    "STPHRAEUBL": True,  # "available in",
    "STPHRAEUGS": True,  # "installation",
    "STPHRAEPB": True,   # "center lane",
    "STPHRAG/STO*EPB": True,       # "flagstone",
    "STPHREU": True,     # "envy",
    "STPHREFPLT": True,  # "investment in",
}
